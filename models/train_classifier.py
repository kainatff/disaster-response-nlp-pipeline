...
def load_data(database_filepath):
    ...
    # selecting only messages receive directly for greater accuracy
...
def build_model():
    # machine learning model using count vectorizer and tf-idf transformer. using Gridsearch ro find best parameters.
    ...
    parameters = {
        ...
        'tfidf__use_idf': [True],
        'clif__estimator__n_estimators': [20]
    }
